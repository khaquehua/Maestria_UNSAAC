...
\begin{minipage}{14cm}
\begin{center}
\fontsize{14pt}{11pt}\selectfont\bfseries{COMPARACIÓN DE LA INFERENCIA BAYESIANA CON LA INFERENCIA ESTADÍSTICA CLÁSICA MEDIANTE REDES BAYESIANAS PARA LA DETECCIÓN DE QUERATOCONO EN EL CUSCO}
\end{center}
\end{minipage}
}
\end{center}
