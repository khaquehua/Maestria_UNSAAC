...
\begin{minipage}{14cm}
\begin{center}
\fontsize{14pt}{11pt}\selectfont\bfseries{COMPARACIÓN DE LA INFERENCIA ESTADÍSTICA BAYESIANA CON LA INFERENCIA ESTADÍSTICA CLÁSICA APLICADO EN LA DECISIÓN DE IDENTIFICACIÓN DEL QUERATOCONO EN EL CUSCO}
\end{center}
\end{minipage}
}
\end{center}
