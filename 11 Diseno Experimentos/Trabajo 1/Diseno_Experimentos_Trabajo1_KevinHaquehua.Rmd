...
Tomando en cuenta el contexto en el que solo se desea evaluar el efecto de cinco fertilizantes, el modelo adecuado a utilizar es un diseño completamente al azar. Evaluando el trabajo original se tomo en cuenta el diseño bloque completo al azar, debido a que se toma en cuenta los días de floración: Primera medición, segunda medición, días de floración y periodo vegetativo.

b) **¿Se puede afirmar que al menos uno de los días de floración difiere del resto al aplicar los distintos fertilizantes complejos?**

Efectivamente, se puede afirmar que revisando el trabajo con los días de floración, influye en que difiera del resto de los distintos fertilizantes complejos.
