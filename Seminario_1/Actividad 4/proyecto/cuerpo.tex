...
Las variables independientes viene a ser las probabilidades de generar queratocono en el nivel que se encuentre, asimismo como la clasificación de presencia o ausencia de esta enfermedad, que va a estar dependiendo principalmente de variables clínicas, demográficas y tomográficas.
...
\begin{longtable}{p{3.5cm}p{6.5cm}p{5cm}p{3cm}p{2.5cm}}
    ...
    \hline \\
    \multirow{4}{*}{Variables demográficas} & \multirow{4}{6.5cm}{Variables tomadas en la revisión de la historia clínica usando test o cuestionarios.} & Ojo seco & Dicotómica & Nominal \\
    \cline{3-5}
    & & Alergias & Dicotómica & Nominal \\
    \cline{3-5}
    & & Frotamiento de ojos & Dicotómica & Nominal \\
